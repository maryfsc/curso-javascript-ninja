(function() {
  ...
  */
  function calculator(operator) {
    return isOperatorValid(operator) ? function(a, b) { 
      return typeof a === 'number' || typeof b === 'number' ? operation[operator](a, b) : false;
     } : false;
  }
  ...
  */
  function showOperationMessage(operator, a, b) {
    return 'A operação ' + a + ' ' + String(operator) + ' ' + b + ' = ';
  }
  ...
  */
  function showErrorMessage(operator) {
    return isOperatorValid(operator) ? null : 'Operação ' + String(operator) + ' não permitida!';
  }
