...
// A função showName retorna Mary.
...
*/
console.log(sum(2, 5)); // Resultado da operação: 2 + 5 = 7.
...
no console.
*/
console.log(subtraction(10, 7)); // Resultado da operação: 10 - 7 = 3.
console.log(multiplication(8, 5)); // Resultado da operação: 8 * 5 = 40.
console.log(division(6, 2)); // Resultado da operação: 6 / 2 = 3.
